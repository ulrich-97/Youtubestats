...
class Account(self):
    ...
    def edit_accountinfo(self, edit):
        ...
        """
    def Intro_program(selection, one, two, three, four, five):
        ...
        Args:
            ...
            five(int): will direct users to their list of videos or channels
            users want to save for future reference. 
        Returns:
...
class RecommendationSystem:
    ...
    channel based on their specific category and view that channel top 10
    ...
    def mainMenu(self, selection):
        ...
        a list of youtube channels to select based on the category selected 
    ...
    def sports(self, sports_tags, extract_videos, sorted_extract, selection):
        """sort list of channel names based on tags matching one more sport
        tags.
        Args:
    ...
    def miscellaneous(self, extract_videos, sorted_extract, selection):
        """
        sort list of channel names that don't associate themselves with any of 
    ...
    def topTrendingVideos(self, extract_videos, videos_sorted, sorted_extract,
        ...
        trending videos from that channel in order from highest to lowest amount
        of likes.
        Args:
...
class Popularvideos:
    ...
    def prompt_channel_search(self):
        ...
        Args:
            ...
            sorted_extract(list): only show users the title of the video, amount
            of views, amount of likes and dislikes on a video.